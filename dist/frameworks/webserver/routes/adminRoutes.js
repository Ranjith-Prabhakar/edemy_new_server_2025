...
const adminRoute = (router) => {
    ...
    //   })
    // );
    router.post("/get_users", auth_1.isAuthenticated, (0, auth_1.autheriseRoles)("admin"), (0, catchAsyncErrors_1.catchAsyncErrors)((req, res, next) => {
    ...
    //   })
    // );
    router.post("/get_instructors", auth_1.isAuthenticated, (0, auth_1.autheriseRoles)("admin"), (0, catchAsyncErrors_1.catchAsyncErrors)((req, res, next) => {
    ...
    router.get("/statistics", auth_1.isAuthenticated, (0, auth_1.autheriseRoles)("admin"), (0, catchAsyncErrors_1.catchAsyncErrors)((req, res, next) => {
        injuctions_1.adminController.getStatistics(req, res, next);
    }));
    return router;
};
