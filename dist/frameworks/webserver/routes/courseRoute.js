...
function courseRoute(router) {
    ...
    router.get("/get_courses_for_user", (0, catchAsyncErrors_1.catchAsyncErrors)((req, res, next) => {
    ...
    router.post("/get_courses_by_category", (0, catchAsyncErrors_1.catchAsyncErrors)((req, res, next) => {
