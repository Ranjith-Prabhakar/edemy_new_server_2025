...
exports.chatController = exports.courseController = exports.adminController = exports.userController = void 0;
...
const messages_1 = require("../../../database/repository/messages");
...
const chatUseCase_1 = require("../../../../useCasese/useCases/chatUseCase");
...
const messageRepository = new messages_1.MessagesRepository();
const userUseCase = new userUseCase_1.UserUsecase(userRepository, bcryptService, generateOTP, sendMail, otpRepository, jwtToken, cloudSession, requestManagement, instrctorAgreementRepository, notificationRepository, authService, conversationRepository);
const adminUseCase = new adminUseCase_1.AdminUseCase(userRepository, instrctorAgreementRepository, categoryRepository, notificationRepository, cloudSession, courseRepository, reviewAndRatingRepository);
const courseUseCase = new courseUseCase_1.CourseUseCase(cloudStorage, courseRepository, categoryRepository, paymentService, paymentRepository, userRepository, cloudSession, reviewAndRatingRepository, courseTrackRepository, notificationRepository, conversationRepository);
const chatUseCase = new chatUseCase_1.ChatUseCase(conversationRepository, messageRepository);
